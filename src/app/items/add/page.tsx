...
export default function AddSupplierPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // This console log represents the data payload that will eventually go to your database
    console.log('Sending this supplier payload to the backend database:', {
      title,
      shortDescription,
      fullDescription,
    ...
    alert(`Successfully registered operational profile for: ${title}`);
  ...
  return (
    <div className="max-w-2xl mx-auto my-12 p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button 
          type="submit" 
          className="w-full bg-teal-700 text-white font-medium p-2.5 rounded-md hover:bg-teal-800 transition"
        >
